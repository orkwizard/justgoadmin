...
const Destination = () => {
  ...
  const product = useSelector(selectDestination);
  ...
  useDeepCompareEffect(() => {
    function updateProductState() {
      ...
      if (destinationId === 'new') {
         ...
         * Get Product data
         */
        dispatch(getDestination(destinationId)).then(action => {
          /**
  ...
  if (
    _.isEmpty(form) ||
    (product && routeParams.destinationId !== product.id && routeParams.destinationId !== 'new')
  ) {
    return <FuseLoading />;
  }
...
export default withReducer('justGo', reducer)(Destination);
